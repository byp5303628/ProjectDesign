...
public class PacketTest {
   private static final String ETHERNET_IP_PACKET = "1524151526251524151526270800";
   private static final String ETHERNET_ARP_PACKET = "ffffffffffff1524151526250806";
   @Test
   public void testMakeArpPacket() {
       String arpRequestPacket = "ffffffffffff1524151526250806000108000604000115241515262501010101ffffffffffffffffffff";
       ...
       String arpResponsePacket = "ffffffffffff1524151526250806000208000604000115241515262501010101ffffffffffffffffffff";
   ...
   public void testMakeIpPacket() {
      String ipPacket = ETHERNET_IP_PACKET + "4500001400000000ff010000c0a80101c0a80102";
