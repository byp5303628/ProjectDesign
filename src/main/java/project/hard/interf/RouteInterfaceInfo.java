...
public class RouteInterfaceInfo extends InterfaceInfo {
     ...
     *
     * @param target , which is the dest ip we want to get its mac address
     * @return
     */
     ...
     *
     * @param pointString , which is the point string like 192.168.1.1
     * @param mask        , which is the mask of the ip address
     ...
     *
     * @param ip , which is the ip you want to check
     * @return
     */
